...
.ads-container {
    ...
    max-height: 700px;
    position: sticky;
    top: 110; /* Stays fixed at the top until it reaches the bottom */
    right: auto;
    left: auto;
    z-index: 9999;
    ...
    @media (min-width: 1024px) {
        .ads-container {
            position: fixed; /* Fix the banner */
            top: 110px; /* Position from top of the page */
            right: 0;
            left: 80px;
            z-index: 9999; /* Ensure it stays on top */
            width: 360px; /* Width to limit the banner's size */
            max-height: 700px; /* Max height for the banner */
        }
    ...
    .ads-container {
        position: relative; /* Reset to relative */
            margin-bottom: 20px; /* Add space if needed */
